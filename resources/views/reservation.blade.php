    ...
    <div class="container-login100">
        <div class="wrap-login100">
                ...
                <span class="login100-form-title p-b-26" id = "reservation-title">
                    {{$game->name}} Reservation ( {{$game->session_duration}} minutes)
                </span>
                        ...
                        <div class="align-items-center d-flex justify-content-lg-between flex-wrap">
                            <div class="p-3 m-auto">
                                <div class="d-flex form-switch">
                                    <input class="form-check-input" type="checkbox" id="secondPlayer" name="2" value="1" checked>
                                    <label style="margin-left: 15px"class="" for="secondPlayer">Second Player</label>
                                </div>
                                <input class="form-control" type="text" name="email2" placeholder="HTU Email" id="email2"  required>
                            </div>
                            <div class="p-3 m-auto">
                                <div class="d-flex form-switch">
                                    <input class="form-check-input" type="checkbox" id="thirdPlayer" name="3" value="1" checked>
                                    <label style="margin-left: 15px" for="thirdPlayer">Third Player</label>
                                </div>
                                <input class="form-control" type="text" name="email3" placeholder="HTU Email" id="email3" required>
                            </div>
                            <div class="p-3 m-auto">
                                <div class="d-flex form-switch">
                                    <input class="form-check-input " type="checkbox" id="fourthPlayer" name="4" value="1" checked>
                                    <label style="margin-left: 15px"class="" for="fourthPlayer">Fourth Player</label>
                                </div>
                                <input class="form-control" type="text" name="email4" placeholder="HTU Email" id="email4" required>
                            </div>
                        </div>
                    </div>
                    <div class="m-auto mt-3 mb-3" style="width: fit-content;">
                        <label style="margin-left: 15px"class="" for="time_slots" class="m-auto">Reservation Time</label>
